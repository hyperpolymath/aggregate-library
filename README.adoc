...
:experimental:
:url-github: https://github.com/hyperpolymath/aggregate-library
:url-gitlab: https://gitlab.com/hyperpolymath/aggregate-library
:url-bitbucket: https://bitbucket.org/hyperpolymath/aggregate-library
:url-codeberg: https://codeberg.org/hyperpolymath/aggregate-library

Data aggregation patterns and streaming collector library
...
aggregate-library is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
